...
struct LovedOneDetailView: View {
    ...
    @State private var editedConversationStarter: String = ""
    ...
    private var displayInfo: some View {
        VStack(spacing: 16) {
            ...
            if let starter = lovedOne.conversationStarter {
                VStack(alignment: .leading, spacing: 8) {
    ...
    private var editForm: some View {
        VStack(spacing: 16) {
            ...
            RinkuTextField(
                ...
                placeholder: "e.g., She drives up from Austin every Sunday.",
                helperText: "One warm thing to know about this person",
                isMultiline: true
            )

            RinkuTextField(
                label: "Conversation Starter",
                text: $editedConversationStarter,
                placeholder: "e.g., Ask her how the baby is doing.",
                helperText: "Something to ask or bring up"
            )
    ...
    private func loadInitialState() {
        ...
        editedConversationStarter = lovedOne.conversationStarter ?? ""
    ...
    private func saveChanges() {
        ...
        updated.conversationStarter = editedConversationStarter.isEmpty ? nil : editedConversationStarter.trimmingCharacters(in: .whitespaces)

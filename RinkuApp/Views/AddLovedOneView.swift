...
struct AddLovedOneView: View {
    ...
    @State private var conversationStarter = ""
    ...
    private enum Field: Hashable {
        case fullName, familiarName, relationship, memoryPrompt, conversationStarter
    }
        ...
        do {
            ...
            await MainActor.run {
                store.addLovedOne(
                    ...
                    conversationStarter: conversationStarter.isEmpty ? nil : conversationStarter.trimmingCharacters(in: .whitespaces),
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 20) {
                        ...
                        RinkuTextField(
                            label: "add_loved_one_conversation_starter".localized,
                            text: $conversationStarter,
                            placeholder: "add_loved_one_conversation_starter_placeholder".localized,
                            isFocused: focusedField == .conversationStarter,
                            onTap: { focusedField = .conversationStarter }
                        )
